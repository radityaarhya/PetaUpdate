...
var format_JURITPLANA_2 = new ol.format.GeoJSON();
var features_JURITPLANA_2 = format_JURITPLANA_2.readFeatures(json_JURITPLANA_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JURITPLANA_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_JURITPLANA_2.addFeatures(features_JURITPLANA_2);
var lyr_JURITPLANA_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_JURITPLANA_2, 
                style: style_JURITPLANA_2,
                interactive: true,
                title: '<img src="styles/legend/JURITPLANA_2.png" /> JURIT PLAN-A'
            });
...
var format_CheckPointJuritPlanA_6 = new ol.format.GeoJSON();
var features_CheckPointJuritPlanA_6 = format_CheckPointJuritPlanA_6.readFeatures(json_CheckPointJuritPlanA_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CheckPointJuritPlanA_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CheckPointJuritPlanA_6.addFeatures(features_CheckPointJuritPlanA_6);
var lyr_CheckPointJuritPlanA_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CheckPointJuritPlanA_6, 
                style: style_CheckPointJuritPlanA_6,
                interactive: true,
                title: '<img src="styles/legend/CheckPointJuritPlanA_6.png" /> CheckPoint Jurit Plan-A'
            });
...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_JalanDroppointAkeWelcoming_1.setVisible(true);lyr_JURITPLANA_2.setVisible(true);lyr_ShortcutPanitia_3.setVisible(true);lyr_NAVDAR12_4.setVisible(true);lyr_CheckPointNavdar12_5.setVisible(true);lyr_CheckPointJuritPlanA_6.setVisible(true);lyr_DropPointuntukPlannAB_7.setVisible(true);lyr_ChekPointBasecampPanitia_8.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_JalanDroppointAkeWelcoming_1,lyr_JURITPLANA_2,lyr_ShortcutPanitia_3,lyr_NAVDAR12_4,lyr_CheckPointNavdar12_5,lyr_CheckPointJuritPlanA_6,lyr_DropPointuntukPlannAB_7,lyr_ChekPointBasecampPanitia_8];
lyr_JalanDroppointAkeWelcoming_1.set('fieldAliases', {'name': 'name', });
lyr_JURITPLANA_2.set('fieldAliases', {'nama': 'nama', });
...
lyr_CheckPointJuritPlanA_6.set('fieldAliases', {'nama_loc': 'nama_loc', 'img': 'img', 'bayangan': 'bayangan', });
...
lyr_JURITPLANA_2.set('fieldImages', {'nama': 'TextEdit', });
...
lyr_CheckPointJuritPlanA_6.set('fieldImages', {'nama_loc': 'TextEdit', 'img': 'TextEdit', 'bayangan': 'TextEdit', });
...
lyr_JURITPLANA_2.set('fieldLabels', {'nama': 'no label', });
...
lyr_CheckPointJuritPlanA_6.set('fieldLabels', {'nama_loc': 'no label', 'img': 'no label', 'bayangan': 'no label', });
