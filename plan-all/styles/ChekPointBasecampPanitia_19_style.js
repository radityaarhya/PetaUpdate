...
var style_ChekPointBasecampPanitia_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("name_loc") !== null) {
        labelText = String(feature.get("name_loc"));
    }
